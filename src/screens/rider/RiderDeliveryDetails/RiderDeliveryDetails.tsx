...
const RiderDeliveryDetails = ({ navigation }: any) => {
        ...
        <BaseWrapper container_style={styles.container}>
            ...
            >
                ...
                <View style={styles.ownerRow}>
                    ...
                    {/* Call */}
                    <TouchableOpacity style={styles.callBox} onPress={() => Utils.makePhoneCall('+1234567890')}>
                        <ImageComponent
                            source={images.call}
                ...
                <View style={{
                    ...
                    <BarcodeBlock
                        title="Pickup Package Qr/Label Detail"
                    />

                    <BarcodeBlock
                        title="Delivered Package Qr/Label Detail"
                    />
                </View>

    ...
    return (
        ...
        >
            <HeadingGroup
                ...
                subheading="Please input  the verification code sent to your email id jacobsmith123@gmail.com"
            />
            <OTPInput
                ref={ref}
            ...
            <View style={styles.resendCodeRow}>
                <Text style={styles.resendCodeText}>Didn't get any code yet? </Text>
                <Pressable
                    onPress={() => Alert.alert('Resend code')}
                    hitSlop={8}
                >
                    <Text style={[styles.resendCodeText, styles.resendCodeTextLink]}>Resend code</Text>
                </Pressable>
            </View>

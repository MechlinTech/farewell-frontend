...
const AnimatedSwitch = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- duration and progress are intentional
  }, [value]);
...
const NotificationSettings = ({ navigation }: any) => {
  ...
  const toggleGeneralSwitch = () =>
    setIsGeneralEnabled(previousState => !previousState);
  return (
    <BaseWrapper>
      <CustomToolbar
      ...
      <View style={styles.container}>
        <View style={styles.notificationContainer}>
          <View style={styles.notificationRow}>
            ...
            <AnimatedSwitch value={isEnabled} onValueChange={toggleSwitch} />
          </View>
          <View style={styles.notificationRow}>
